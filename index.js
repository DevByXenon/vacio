var Libro = /** @class */ (function () {
    ...
    Libro.prototype.getAntiguedad = function () {
        ...
        var antiguedad = añoActual - this.añoPublicacion;
        return antiguedad;
    };
    return Libro;
}());
...
var libro1 = new Libro("El principito", "Antoine de Saint-Exupéry", 1943);
...
console.log("El libro \"".concat(libro2.titulo, "\" de ").concat(libro2.autor, ", publicado en ").concat(libro2.añoPublicacion, ", tiene ").concat(libro2.getAntiguedad(), " a\u00F1os de antiguedad"));
